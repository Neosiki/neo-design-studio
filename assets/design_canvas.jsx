/**
 * DesignCanvas — 변형 나란히 그리드 레이아웃
 *
 * 정적 디자인 variations 2+개를 표시하여 사용자가 비교·선택할 수 있게 합니다。
 * 각 variation에는 label이 있으며 hover하면 확대됩니다。
 *
 * 사용법：
 *   <DesignCanvas
 *     title=\"Hero구역 디자인 탐색\"
 ...
 *     columns={3}
 *   >
 *     <Variation label=\"Minimal\" description=\"미니멀 절제판\">
 *       <div>...당신의 디자인1...</div>
 *     </Variation>
 *     <Variation label=\"Editorial\" description=\"잡지 편집 스타일\">
 *       <div>...당신의 디자인2...</div>
 *     </Variation>
 *     <Variation label=\"Brutalist\" description=\"거칠고 원시적\">
 *       <div>...당신의 디자인3...</div>
 *     </Variation>
 *   </DesignCanvas>
 *
 * React+Babel과 함께 사용합니다。적절한 script 안에 넣으면 window.DesignCanvas/window.Variation을 사용할 수 있습니다。
 */
